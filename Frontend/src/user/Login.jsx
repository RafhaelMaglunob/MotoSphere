        ...
        <div className="h-screen overflow-hidden bg-[url('./component/img/AdminLogin.png')] bg-[length:100%_100%] bg-no-repeat bg-center">
            <div className="md:h-[100vh] h-screen flex justify-center items-center">
                <div className="bg-[#0F2A52]/85 p-10 flex flex-col items-center rounded-2xl">
                    <span className="text-[#22D3EE] text-sm px-10 py-2 bg-[#06B6D4]/10 rounded-[50px]">⬤ User Portal</span>
                    <img src={Shield} alt="Shield" className="w-20 h-20" />
                    <h1 className="font-bold text-white text-xl">User Login</h1>
                    ...
                    <div className="flex flex-col items-start w-full mt-6 gap-2">
                        ...
                        <input type="text" placeholder="User@motosphere.com" className="bg-[#0A1A3A] text-[#CCCCCC] text-sm w-70 md:w-80 px-4 py-3 rounded-lg"></input>
                    </div>

                    <div className="flex flex-col items-start w-full mt-6 gap-2">
                        <label className="text-sm text-[#9BB3D6]">Password</label>
                        <div className="relative">
                            <input type={showPassword ? "text" : "password"} placeholder="Enter User password" className="bg-[#0A1A3A] text-[#CCCCCC] text-sm w-70 md:w-80 px-4 py-3 rounded-lg"></input>
                            <span
